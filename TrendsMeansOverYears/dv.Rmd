...
---
## R Markdown
This file downloads google trends for the freebase keyword "domestic violence (/m/02gr_)" and calculates means for the lockdown intervals of individual countries for the years 2019 and 2020. A relatedqueries.csv file is also created to see what search terms may have been part of the calculated means.
...
relatedqueries<-do.call("rbind", list(gtrendsresultau$related_queries, gtrendsresultec$related_queries, gtrendsresultng$related_queries,
gtrendsresultar$related_queries,gtrendsresultro$related_queries,
gtrendsresultde$related_queries$related_queries))
write.csv(relatedqueries,"relatedqueries.csv", row.names = FALSE)
```
```{r calculate means }
